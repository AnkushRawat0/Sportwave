    ...
    <div className="bg-white">
      ...
      <section className="px-4 md:px-10 pt-24 flex flex-col md:flex-row md:items-start items-center max-w-7xl mx-auto" id="home">
        ...
        <div className="md:w-1/2 text-left md:pr-12 md:pt-16">
          ...
          <div className="mt-8">
            <button onClick={() => setShowLogin(true)} className={`bg-indigo-600 text-white px-6 py-3 rounded-full shadow-md hover:bg-indigo-500 transition ${montserrat.className}`}>
              Get Started
            </button>
          </div>
        </div>

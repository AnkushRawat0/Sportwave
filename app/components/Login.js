...
const Login = () => {
    ...
    return (
        ShowSignup ? <Signup /> :
            <div className='flex flex-col items-center min-h-[70vh] w-96 rounded-3xl bg-gradient-to-b from-indigo-500 via-indigo-100 to-white pb-6'>
                ...
                <div className='flex flex-col p-2 mt-6 items-center justify-center w-[80%]'>
                    <div className="flex items-center w-full bg-white rounded-xl p-2 mt-4 shadow-xl">
                        ...
                        <input type="text" placeholder="Email" value={email} className={`p-2 rounded-xl w-full text-black focus:outline-none ${montserrat.className}`} onChange={handleChange} name="email" />
                    </div>
                    ...
                    <div className='flex  items-center justify-center w-full bg-white rounded-xl p-2 mt-4 shadow-xl'>
                        ...
                        <input type={showPassword ? "text" : "password"} placeholder='Password' value={password} className={`p-2 rounded-xl w-full text-black ${montserrat.className}`} onChange={handleChange} name="password" />
